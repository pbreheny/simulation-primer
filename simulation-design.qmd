...
1. The methods (and anything else you might be blocking on) need to come _before_ the replication indicator.
...
- The above structure allows for specifying options from the command line; in this case, you might modify the block that specifies the options as follows:
